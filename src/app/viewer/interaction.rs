...
pub(in crate::app) use wheel::WHEEL_ZOOM_DELTA_EPSILON;
use wheel::{route_wheel_scroll, WheelBehavior, WheelScrollRoute};
...
mod tests {
    use super::{
        target_long_edge_for_view, view_target_settle_wait, OriginalPageSize, ViewTargetSignature,
        VIEW_TARGET_SETTLE_DELAY,
    };
