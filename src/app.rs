use crate::core::effects::{
    apply_effects_to_image, compose_images_horizontally, transformed_page_size, ImageFilter,
    ViewEffects,
};
...
use crate::core::state::{
    ...
    DecoderPreferences, DisplayUpscaler, FitMode, LargeImageAnchor, MouseGesture,
