...
#[test]
fn adopt_record_accepts_a_canonical_alias_and_normalizes_manual_bookmark_paths() {
    ...
    assert!(adopted
        .path_positions
        .contains_key(folder.to_string_lossy().as_ref()));
    assert_eq!(
        adopted.page_bookmarks[0].source_path,
