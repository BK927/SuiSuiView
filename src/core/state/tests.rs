...
fn automatic_display_upscaler_only_uses_heavy_shader_for_actual_upscale() {
    ...
    assert_eq!(
        DisplayUpscaler::WgslArtcnnC4F16.resolve_for_render([800, 1200], [1600, 2400]),
...
fn product_display_upscalers_hide_style_candidates() {
    ...
    assert!(DisplayUpscaler::ALL.contains(&DisplayUpscaler::Cunny4x16Soft));
    assert!(DisplayUpscaler::ALL.contains(&DisplayUpscaler::Cunny4x16Ds));
    ...
    assert!(DisplayUpscaler::ALL.contains(&DisplayUpscaler::Cunny4x32Soft));
    assert!(DisplayUpscaler::ALL.contains(&DisplayUpscaler::Cunny4x32Ds));
    assert!(DisplayUpscaler::ALL.contains(&DisplayUpscaler::Cunny8x32Nvl));
    assert!(DisplayUpscaler::ALL.contains(&DisplayUpscaler::Cunny8x32Ds));
    assert!(
    ...
    assert_eq!(DisplayUpscaler::Cunny4x16Soft.candidate().family, "CuNNy");
    assert_eq!(DisplayUpscaler::Cunny4x16Ds.candidate().family, "CuNNy");
    ...
    assert_eq!(DisplayUpscaler::Cunny4x32Soft.candidate().family, "CuNNy");
    assert_eq!(DisplayUpscaler::Cunny4x32Ds.candidate().family, "CuNNy");
    assert_eq!(DisplayUpscaler::Cunny8x32Ds.candidate().family, "CuNNy");
    assert!(DisplayUpscaler::Cunny4x16Soft.candidate().product_visible);
    assert!(DisplayUpscaler::Cunny4x16Ds.candidate().product_visible);
    ...
    assert!(DisplayUpscaler::Cunny4x32Soft.candidate().product_visible);
    assert!(DisplayUpscaler::Cunny4x32Ds.candidate().product_visible);
    assert!(DisplayUpscaler::Cunny8x32Ds.candidate().product_visible);
    assert!(DisplayUpscaler::Cunny4x16Soft.product_selectable());
    assert!(DisplayUpscaler::Cunny4x16Ds.product_selectable());
    assert!(DisplayUpscaler::Cunny4x24Soft.product_selectable());
    assert!(DisplayUpscaler::Cunny4x24Ds.product_selectable());
    assert!(DisplayUpscaler::Cunny4x32Soft.product_selectable());
    assert!(DisplayUpscaler::Cunny4x32Ds.product_selectable());
    assert!(DisplayUpscaler::Cunny8x32Ds.product_selectable());
    assert!(!DisplayUpscaler::Cunny4x16Soft.is_benchmark_only());
    assert!(!DisplayUpscaler::Cunny4x16Ds.is_benchmark_only());
    assert!(!DisplayUpscaler::Cunny4x24Soft.is_benchmark_only());
    assert!(!DisplayUpscaler::Cunny4x24Ds.is_benchmark_only());
    assert!(!DisplayUpscaler::Cunny4x32Soft.is_benchmark_only());
    assert!(!DisplayUpscaler::Cunny4x32Ds.is_benchmark_only());
    assert!(!DisplayUpscaler::Cunny8x32Ds.is_benchmark_only());
    assert_eq!(
    ...
    assert_eq!(DisplayUpscaler::Cunny4x16Soft.label(), "CuNNy 4x16 SOFT");
    assert_eq!(DisplayUpscaler::Cunny4x16Ds.label(), "CuNNy 4x16 DS");
    ...
    assert_eq!(DisplayUpscaler::Cunny4x32Soft.label(), "CuNNy 4x32 SOFT");
    assert_eq!(DisplayUpscaler::Cunny4x32Ds.label(), "CuNNy 4x32 DS");
    assert_eq!(DisplayUpscaler::Cunny8x32Nvl.label(), "CuNNy 8x32 NVL");
    assert_eq!(DisplayUpscaler::Cunny8x32Ds.label(), "CuNNy 8x32 DS");
}
...
fn exact_cunny_variants_render_only_when_upscaling() {
    ...
    assert_eq!(
        DisplayUpscaler::Cunny4x16Soft.resolve_for_render([800, 1200], [1600, 2400]),
        Some(DisplayUpscaler::Cunny4x16Soft)
    );
    assert_eq!(
        DisplayUpscaler::Cunny4x16Ds.resolve_for_render([800, 1200], [1600, 2400]),
        Some(DisplayUpscaler::Cunny4x16Ds)
    );
    assert_eq!(
    ...
    assert_eq!(
        DisplayUpscaler::Cunny4x32Soft.resolve_for_render([800, 1200], [1600, 2400]),
        Some(DisplayUpscaler::Cunny4x32Soft)
    );
    assert_eq!(
        DisplayUpscaler::Cunny4x32Ds.resolve_for_render([800, 1200], [1600, 2400]),
        Some(DisplayUpscaler::Cunny4x32Ds)
    );
    assert_eq!(
    ...
    assert_eq!(
        DisplayUpscaler::Cunny8x32Ds.resolve_for_render([800, 1200], [1600, 2400]),
        Some(DisplayUpscaler::Cunny8x32Ds)
    );
    assert_eq!(
